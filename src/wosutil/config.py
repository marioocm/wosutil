...
TEMPLATE_PATHS = {
    ...
    "worldmap_search_meat": os.path.join(TEMPLATES_DIR, "world", "gather", "worldmap_search_meat.png"),
    "worldmap_search_wood": os.path.join(TEMPLATES_DIR, "world", "gather", "worldmap_search_wood.png"),
    "worldmap_search_coal": os.path.join(TEMPLATES_DIR, "world", "gather", "worldmap_search_coal.png"),
    "worldmap_search_iron": os.path.join(TEMPLATES_DIR, "world", "gather", "worldmap_search_iron.png"),
